        ...
        <body>
            <div class="w3-card-4">
                ...
                <header class="w3-container w3-teal">
                    <h1>Students List
                        <a class = "w3-btn w3-round " href="/alunos/registo">+</a>
                    </h1>
                </header>
    ...
    for(let i=0; i < slist.length ; i++){
        pagHTML += `
                <tr>
                    ...
                    <td>${slist[i].github}</td>
                    <td>[<a href="/alunos/edit/${slist[i].id}">Edit</a>][<a href="/alunos/delete/${slist[i].id}">Delete</a>]</td>
                </tr>
        `
    }
            ...
            <div class="w3-card-4">
                ...
                <form class="w3-container" method="POST">
                    <fieldset>
                        ...
                        <label>Git</label>
                        <input class="w3-input w3-round" type="text" name="github"/>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <label>TPC1</label>
                        <input class="w3-check" type="checkbox" name="tpc2" value="2"/>
                        <label>TPC2</label>
                        <input class="w3-check" type="checkbox" name="tpc3" value="3"/>
                        <label>TPC3</label>
                        <input class="w3-check" type="checkbox" name="tpc4" value="4"/>
                        <label>TPC4</label>
                        <input class="w3-check" type="checkbox" name="tpc5" value="5"/>
                        <label>TPC5</label>
                        <input class="w3-check" type="checkbox" name="tpc6" value="6"/>
                        <label>TPC6</label>
                        <input class="w3-check" type="checkbox" name="tpc7" value="7"/>
                        <label>TPC7</label>
                        <input class="w3-check" type="checkbox" name="tpc8" value="8"/>
                        <label>TPC8</label>
                    </fieldset>  
                    <br/>
            ...
            <div class="w3-card-4">
                ...
                <form class="w3-container" method="POST">
                    <fieldset>
                        ...
                        <label>Git</label>
                        <input class="w3-input w3-round" type="text" name="github" value="${a.github}"/>
                    </fieldset>
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
                <ul class="w3-ul w3-card-4" style="width:50%">
                    ...
                    <li><b>Git (link): </b> <a href="${aluno.github}">${aluno.github}</a></li>
                </ul>
            </div>
